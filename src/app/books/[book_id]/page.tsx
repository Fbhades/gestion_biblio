...
export default function PageDetails() {
  ...
  {[...Array(5)].map((_, i) => (
    <button
      ...
      className={`w-10 h-10 flex items-center justify-center border rounded-full mr-1 ${
        rating > i ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700"
      }`}
    >
